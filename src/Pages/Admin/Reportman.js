...
//modal settings
  ...
  return (
    ...
    <ButtonAppBar page='reportman'/>
    
    <h2 style={{textAlign:'center',color:'#1e81b0'}}>Recent Post Reports</h2> 
    <TextField component="form" id="outlined-basic" style={{marginLeft:'15%',width:'70%'}} onChange={searchHandler} label="Search" variant="outlined" />
